...
/** Pointer equality: used for class objects, arrays, and nil comparisons. */
public class IrCommandBinopEqPointers extends IrCommand
{
	...
	public String toString() {
		return "Temp_" + dst.getSerialNumber() + " := ptr_eq(Temp_" + t1.getSerialNumber() + ", Temp_" + t2.getSerialNumber() + ")";
	}
